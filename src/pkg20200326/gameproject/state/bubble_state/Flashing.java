 ...
 */
public class Flashing extends BubbleState{
    public static final String TYPE ="Flashing";
    ...
    public Flashing(Bubble bubble, int bubbleIndex) 
    {
        super(bubble);
    ...
    {
        if(bubble.getCounter() % 3 == 0) // create flashing effect by printing everything 3 frames
        {
