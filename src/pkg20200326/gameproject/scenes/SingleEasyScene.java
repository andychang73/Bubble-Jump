 ...
 * @author chant
 */
public class SingleEasyScene extends Scene {
    ...
    public SingleEasyScene(SceneController sceneController, String nameA) {
    ...
    public void sceneBegin() {
        ...
        this.actor1_bubbleDelayFrame = 90;
        this.rainLimit = 30;
        this.delay = new Delay(60);
        this.winDelay = 2;
        this.ranks = new RankEasyArray();
    }
    ...
    public void write(RankEasyArray ranks, String fileName) {
        try {
            BufferedWriter bw = new BufferedWriter(new FileWriter(fileName));
