 ...
 * @author chant
 */
public class IntroBinEasyScene extends Scene {
    ...
    public IntroBinEasyScene(SceneController sceneController) {
        super(sceneController);
    }

    @Override
    public void sceneBegin() {
        this.img = ImageResourceController.getInstance().tryGetImage(ImagePath.INTROBINE);
