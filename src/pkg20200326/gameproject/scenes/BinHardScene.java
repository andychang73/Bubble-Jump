...
import pkg20200326.gameproject.gameobject.RainPool;
import pkg20200326.gameproject.gameobject.Snowflake;
import pkg20200326.gameproject.gameobject.bubbles.Bubble;
import pkg20200326.gameproject.util.Camera;
import pkg20200326.gameproject.util.Clock;
 ...
 * @author chant
 */
public class BinHardScene extends Scene {
    ...
    private int actor2_yellowDelayFrame;
    private int rainLimit;
    private Delay delay;
    private int winDelay;
    private BufferedImage img;

    public BinHardScene(SceneController sceneController) {
    ...
    public void sceneBegin() {
        ...
        this.actor1_bubbleDelayFrame = 30;
        this.actor2_bubbleDelayFrame = 60;
        this.actor1_yellowDelayFrame = 240;
        this.actor2_yellowDelayFrame = 240;
        this.rainLimit = 30;
    ...
    public void paint(Graphics g) {
        ...
        if (actor2_yellowDelayFrame >= 240) {
            g.drawImage(img, 1625, 0, 1650, 25, 400, 385, 800, 770, null);
        }
        ////////////////////Bubble List////////////////////
        for (int i = 0; i < actor1_bubbleList.size(); i++) {
        ...
        public void keyPressed(int commandCode, long trigTime) {
            switch (commandCode) {
                ...
                case Global.B_BUBBLES:
                    if (actor2_bubbleDelayFrame >= 60) {
                        createBubble(actor2, actor2_bubbleList);
                        actor2_bubbleDelayFrame = 0;
                    }
                    break;
                case Global.B_YELLOW_BUBBLE:
                    if (actor2_yellowDelayFrame >= 240) {
                        createYellowBubble(actor2, actor2_bubbleList);
                        actor2_yellowDelayFrame = 0;
                    }
                    break;
            }
        }
