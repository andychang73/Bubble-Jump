 ...
 * @author chant
 */
public class SinTreasureScene extends Scene {
    ...
    public SinTreasureScene(SceneController sceneController, int sec, String nameA, int heightA, int heightB) {
    ...
    public void sceneBegin() {
        ...
        this.treaDelay = new Delay(15);
        this.treaTime = 0;
        this.treasureDelay = new Delay(15);
        this.treasureOpen = 0;
    ...
    public void paint(Graphics g) {
        ...
        Font name = new Font("微軟正黑體", Font.BOLD, 35);
        g.setColor(Color.BLACK);
        g.setFont(name);
        g.drawString(String.valueOf(this.nameA), 180, 50);
        ...
        Font sec = new Font("微軟正黑體", Font.BOLD, 35);
        g.setColor(Color.BLACK);
        g.setFont(sec);
        g.drawString("秒數： " + String.valueOf(this.sec), 180, 177);
